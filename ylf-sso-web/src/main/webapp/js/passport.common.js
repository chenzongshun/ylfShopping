	...
	handle.show=function(func){
		if(!shade){
		  ...
		  if((document.compatMode=='CSS1Compat')){
			  ...
			  var cw = document.documentElement.clientWidth,sw = document.documentElement.scrollWidth, ow=document.documentElement.offsetWidth;
			  var width = cw > sw ? cw : sw;
			  width = width > ow ? width : ow;
			  ...
			  var cw = document.body.clientWidth,sw = document.body.scrollWidth, ow=document.body.offsetWidth;
			  var width = cw > sw ? cw : sw;
			  width = width > ow ? width : ow;
...
var Win = new function(){
	...
	handler.show = function(html, func, closebtn){
	    ...
	    if((document.compatMode=='CSS1Compat')){
			win.style.display = 'block';
			win.innerHTML = html;
			var ch=document.documentElement.clientHeight,sh=document.documentElement.scrollHeight, oh=document.documentElement.offsetHeight;
			var height = ch;
			var cw = document.documentElement.clientWidth,sw = document.documentElement.scrollWidth, ow=document.documentElement.offsetWidth;
			var width = cw < sw ? cw : sw;
	    	...
	    	win.style.display = 'block';
			win.innerHTML = html;
			var ch=document.body.clientHeight,sh=document.body.scrollHeight, oh=document.body.offsetHeight;
			var height = ch;
			var cw = document.body.clientWidth,sw = document.body.scrollWidth, ow=document.body.offsetWidth;
			var width = cw < sw ? cw : sw;
