...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
	...
	<input type="hidden" name="orderShipping.receiverName" value="陈宗顺"/>
	<input type="hidden" name="orderShipping.receiverMobile" value="13007322150"/>
	<input type="hidden" name="orderShipping.receiverState" value="湖南省"/>
	<input type="hidden" name="orderShipping.receiverCity" value="娄底市"/>
	<input type="hidden" name="orderShipping.receiverDistrict" value="娄星区"/>
	<input type="hidden" name="orderShipping.receiverAddress" value="湖南省娄底市娄星区娄底职业技术学院"/>
  ...
  <div id="userAddrId" class="orderTbody ">
    ...
    <div class="orderItem">
        <div class="orderCurr" id="userAddress" style="display:block;">
          <ul>
            <li>陈宗顺&nbsp;&nbsp;&nbsp;&nbsp;13007322150&nbsp;&nbsp;&nbsp;&nbsp;湖南省&nbsp;&nbsp;娄底市&nbsp;&nbsp;娄星区&nbsp;&nbsp;娄底职业技术学院</li>
          </ul>
        </div>
    </div>
  </div>
