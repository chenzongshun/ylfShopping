...
//    }
     ...
     * @return
     */
    public static ylfResult formatToPojo(String jsonData, Class<?> clazz) {
        try {
            if (clazz == null) {
                return MAPPER.readValue(jsonData, ylfResult.class);
            }
     ...
     * @return
     */
    public static ylfResult format(String json) {
        try {
            return MAPPER.readValue(json, ylfResult.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * @return
     */
    public static ylfResult formatToList(String jsonData, Class<?> clazz) {
        try {
            JsonNode jsonNode = MAPPER.readTree(jsonData);
            JsonNode data = jsonNode.get("data");
            Object obj = null;
